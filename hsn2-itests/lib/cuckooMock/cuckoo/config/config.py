...
class CuckooConfig:
    ...
    def __init__(self):
        ...
        if os.path.exists(self.config_file):
            try:
                ...
                print(("[Config] [ERROR] Cannot read config file \"%s\": %s."
                          % (self.config_file, why)))
                sys.exit(-1)
        else:
            print(("[Config] [ERROR] Cannot find config file \"%s\"."
                      % self.config_file))
            sys.exit(-1)
    ...
    def _error_parse(self, why):
        ...
        """
        print(("[Config] [ERROR] Error parsing config file: \"%s\": %s."
                  % (self.config_file, why)))
    ...
    def _error_config(self):
        ...
        Prints an error.
        """
        print(("[Config] [ERROR] ConfigParser not properly initialized."))
